...
from transformers.utils.parallel_state import initialize_model_parallel, sequence_parallel_is_initialized, get_sequence_parallel_world_size, get_sequence_parallel_rank
...
def main():
    ...
    if args.local_rank == -1:
        ...
        initialize_model_parallel(sequence_parallel_size=args.sp)
        assert sequence_parallel_is_initialized()
    ...
    ds_config = get_train_ds_config(offload=args.offload,
                                    ...
                                    enable_mixed_precision_lora=args.lora_dim > 0,
                                    tb_name="step1_model")
    ds_config[
    ...
    def sp_data_collator(features, return_tensors="pt"):
